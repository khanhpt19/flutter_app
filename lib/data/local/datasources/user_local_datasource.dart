...
import 'package:flutter_app/data/exceptions/local_server_exception.dart';
import 'package:flutter_app/data/local/local_consts.dart';
...
class UserLocalDataSource extends AppLocalizationBase {
  ...
  UserLocalDataSource({@required this.database}) {
    UserModel userModel = UserModel(
        ...
        country: "VN",
        fullname: "Khanh",
        twitterAccount: "https://github.com/khanhpt19");
